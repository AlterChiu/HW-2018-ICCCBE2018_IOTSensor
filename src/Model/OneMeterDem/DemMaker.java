...
public class DemMaker {
	...
	// buffer cell size
	private static int bufferCellSize = 10;
	...
	// save name
	private static String saveName = "buffer100m+10m(10m)_Hy";
	...
	public static void main(String[] args) throws IOException {
		...
		AsciiBasicControl ascii = new AsciiBasicControl("S:\\HomeWork\\ICCCBE2018\\LevelDEM\\IOT_1m\\Hy_Dem(10m).asc");
		System.out.println("ascii finish");

		for (String station : iotPosition.keySet()) {
			AsciiBasicControl knAscii = new AsciiBasicControl("S:\\HomeWork\\ICCCBE2018\\LevelDEM\\ZoneU1_20m(kn).asc");
			...
			// }
			// }
			// new AtFileWriter(oriAscii.getAsciiFile() , saveAdd + station +
			// "\\ZoneU1_20m(clip).asc").textWriter(" ");
			// new AtFileWriter(knAscii.getAsciiFile() , saveAdd + station +
			// "\\ZoneU1_20m(clip)(kn).asc").textWriter(" ");
			// oriAscii = new
			// AsciiBasicControl("C:\\Sobek213\\TANZ1U01.lit\\DEM\\ZoneU1_20m.asc");
			...
			new AtFileWriter(outKnAscii.getAsciiFile(), saveAdd + station + "\\" + saveName + "(kn).asc")
					.textWriter("    ");
